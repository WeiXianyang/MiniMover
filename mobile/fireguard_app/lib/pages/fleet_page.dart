...
class _FleetPageState extends State<FleetPage> {
  ...
  void initState() {
    ...
    if (widget.fleetService.state.cars.isEmpty) {
      widget.fleetService.initMockFleet();
    }
  }
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              PageHeader(
                title: '车队编队',
                subTitle: '主车领航 + 多从车跟随编队',
                badgeText: _statusText(_fleet.status),
                badgeActive: _fleet.status != FleetStatus.idle,
              ),
              const SizedBox(height: 20),
              // 主车卡片
              if (_fleet.leader != null) _buildCarCard(_fleet.leader!, isLeader: true),
              // 从车卡片
                ...
                children: [
                  Expanded(
                    child: GradientButton(
                      text: halted ? '🚀 行进中…' : '🚀 出发',
                      onTap: halted ? null : () => widget.fleetService.startFleet(),
                    ),
                  ),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border:
                        Border.all(color: AppTheme.statusRed.withAlpha(40)),
        ...
        child: Row(
          children: [
            ...
            Icon(
              ...
              size: 8,
              color: car.online ? AppTheme.statusGreen : AppTheme.textSecondary,
            ),
          ],
        ),
      ),
