...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'route_patrol = yahboomcar_nav.route_patrol:main',
            'initial_pose_setter = yahboomcar_nav.initial_pose_setter:main',
            'patrol_api_bridge = yahboomcar_nav.patrol_api_bridge:main',
        ],
    },
)
